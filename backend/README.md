...
## Project Structure
    ...
    ├── car_dealership_exam_43792  # Django project configurations
...
1. Clone this repo and `cd car_dealership_exam_43792`
...
2. Clone this repo and `cd car_dealership_exam_43792`
